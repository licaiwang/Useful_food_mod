...
public class usefulfood implements ModInitializer {
    ...
    public static final Item Turkey_Feast =  new FoodBase(new Item.Settings().group(ItemGroup.FOOD).food(new FoodComponent.Builder().hunger(16).meat().saturationModifier(10f).statusEffect(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 20*300), 1f).statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 20*30), 1f).build()));
