...
public class usefulfood implements ModInitializer {
    public static final String MODID = "usefulfoodmod";
    ...
    public static final Item Ration = new FoodBase(new Item.Settings().group(ItemGroup.FOOD).food(new FoodComponent.Builder().hunger(2).snack().saturationModifier(6f).alwaysEdible().statusEffect(new StatusEffectInstance(StatusEffects.INSTANT_HEALTH,1), 1f).build()));
    public static final Item Suspicious_Meat = new FoodBase(new Item.Settings().group(ItemGroup.FOOD).food(new FoodComponent.Builder().hunger(6).saturationModifier(6f).meat().alwaysEdible().statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA,20*15), 0.4f).statusEffect(new StatusEffectInstance(StatusEffects.INSTANT_DAMAGE,10), 0.3f).build()));
    ...
    public static final Item Raw_Turkey_Feast =  new FoodBase(new Item.Settings().group(ItemGroup.FOOD).food(new FoodComponent.Builder().hunger(4).meat().saturationModifier(2f).alwaysEdible().statusEffect(new StatusEffectInstance(StatusEffects.POISON, 20*2), 0.5f).build()));
    public static final Item Turkey_Feast =  new FoodBase(new Item.Settings().group(ItemGroup.FOOD).food(new FoodComponent.Builder().hunger(16).meat().saturationModifier(10f).alwaysEdible().statusEffect(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 20*300), 1f).statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 20*30), 1f).build()));
    ...
    public static final Item Chew_Bones = new FoodBase(new Item.Settings().group(ItemGroup.FOOD).food(new FoodComponent.Builder().snack().alwaysEdible().saturationModifier(4f).statusEffect(new StatusEffectInstance(StatusEffects.RESISTANCE, 20*60), 0.5f).build()));
    public static final Item Seafood_Feast = new FoodBase(new Item.Settings().group(ItemGroup.FOOD).food(new FoodComponent.Builder().hunger(20).saturationModifier(20f).alwaysEdible().statusEffect(new StatusEffectInstance(StatusEffects.WATER_BREATHING, 20*300), 1f).statusEffect(new StatusEffectInstance(StatusEffects.NIGHT_VISION, 20*300), 1f).build()));
